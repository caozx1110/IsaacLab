...
It renames all the occurrences of quiet_walk (in files, directories, etc.) to the new project name.
"""
...
if __name__ == "__main__":
    ...
    if proceed.lower() == "y":
        # rename the quiet_walk folder
        os.rename(
            os.path.join(root_dir_path, "exts", "quiet_walk", "quiet_walk"),
            os.path.join(root_dir_path, "exts", "quiet_walk", new_name),
        )
        os.rename(os.path.join(root_dir_path, "exts", "quiet_walk"), os.path.join(root_dir_path, "exts", new_name))
